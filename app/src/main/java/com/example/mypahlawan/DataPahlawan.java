...
public class DataPahlawan {
    ...
    public static ArrayList<ModelPahlawan> getHeroList() {
        ModelPahlawan mp_ModelPahlawan = null;
        ArrayList<ModelPahlawan> list = new ArrayList<>();

        for (int i = 0; i < heroNames.length; i++) {
            ModelPahlawan modelPahlawan = new ModelPahlawan();
            modelPahlawan.setHeroName(heroNames[i]);
            modelPahlawan.setHeroDetail(heroDetails[i]);
            modelPahlawan.setHeroImage(heroesImages[i]);
